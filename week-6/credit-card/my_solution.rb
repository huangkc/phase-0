...
# We used #reduce to find the sum of the digits and 
# chained the methods together when feasible.
# We also divided the code into two methods that can be called 
